...
exports.handler = async (event) => {
    ...
    try {
        ...
        const prdUrl = 'https://www.instituteofsustainabilitystudies.com/wp-json/wc/v3/orders';
        const stageUrl = 'https://stage.instituteofsustainabilitystudies.com/wp-json/wc/v3/orders';
        ...
        const getOrderDetails = async () => {
            ...
            try {
                ...
                const moduleCourseIdMap = {
                    ...
                    "Certificate in Corporate Sustainability Reporting Directive (CSRD) - Free": "2730358",
        ...
        if (participants.length > 0) {
            ...
            for (const participant of participants) {
                ...
                for (const courseId of selectedCourseIds) {
                    ...
                    await fetch('https://hooks.zapier.com/hooks/catch/14129819/2u3wbzw/', {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json"
                        },
